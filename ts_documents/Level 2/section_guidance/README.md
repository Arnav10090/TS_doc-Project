# Level 2 Section Guidance Files

## Purpose

This directory contains **section-specific guidance files** for the Level 2 Production Management
System (L2 PMS) TS type. Each `.txt` file provides targeted writing instructions for a specific
TS template section.
...
Level 2-specific: <L2 PMS-particular considerations>
```
