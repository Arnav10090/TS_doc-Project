# HSM TS Type Context Architecture

## Purpose
This directory contains the production-ready context files and section guidance mapping for the Hot Strip Mill (HSM) Coil Yard & Slab Yard Management System TS Type.
